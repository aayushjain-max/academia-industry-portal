...
export default function AutoGeneratedPage() {
  ...
  return (
    <NodePageShell
      ...
      nodeStatus="CORP TIER-1"
      category="INDUSTRY PORTAL // REQUISITIONS & TALENT ACQUISITION"
      title="Micro Internships"
      description="Industry Portal - Micro Internships module."
      actions={
        <>
      ...
      kpis={[
        { label: 'Active Requisitions', value: '18 ROLES', delta: 'OPTIMAL', deltaType: 'success', subtext: 'Updated Today', icon: 'dashboard' },
        { label: 'Matched Candidates', value: '304', delta: '+4.1%', deltaType: 'success', subtext: 'Cohort Standard', icon: 'verified' },
        { label: 'Conversion Rate', value: '76.2%', delta: 'SYNCHRONIZED', deltaType: 'neutral', subtext: 'Root Validated', icon: 'token' },
        { label: 'Security Tier', value: 'TIER 3', delta: 'AICTE TIER-1', deltaType: 'neutral', subtext: 'SIH-2024 Compliant', icon: 'shield' },
      ]}
    >
      {/* Control Ribbon */}
