...
export default function AutoGeneratedPage() {
  ...
  return (
    <NodePageShell
      ...
      category="INSTITUTION PORTAL // ACCREDITATION & COHORT TELEMETRY"
      title="Internship Analytics"
      description="Institution Portal - Internship Analytics module."
      actions={
        <>
      ...
      kpis={[
        { label: 'Cohort Strength', value: '12,480', delta: 'OPTIMAL', deltaType: 'success', subtext: 'Updated Today', icon: 'dashboard' },
        { label: 'Placement Velocity', value: '84.2%', delta: '+4.1%', deltaType: 'success', subtext: 'Cohort Standard', icon: 'verified' },
        { label: 'Audit Standard', value: 'NAAC A++', delta: 'SYNCHRONIZED', deltaType: 'neutral', subtext: 'Root Validated', icon: 'token' },
        { label: 'NIRF Rank', value: '#03 NATL', delta: 'AICTE TIER-1', deltaType: 'neutral', subtext: 'SIH-2024 Compliant', icon: 'shield' },
      ]}
    >
      {/* Control Ribbon */}
