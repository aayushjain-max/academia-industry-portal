...
export default function AutoGeneratedPage() {
  ...
  return (
    <NodePageShell
      ...
      category="ACADEMICIAN PORTAL // FACULTY RESEARCH & MENTORSHIP"
      title="Faculty Internships"
      description="Academician Portal - Faculty Internships module."
      actions={
        <>
      ...
      kpis={[
        { label: 'Active Grants', value: 'INR 1.85 CR', delta: 'OPTIMAL', deltaType: 'success', subtext: 'Updated Today', icon: 'dashboard' },
        { label: 'Citations', value: '3,420+', delta: '+4.1%', deltaType: 'success', subtext: 'Cohort Standard', icon: 'verified' },
        { label: 'H-Index', value: 'H-28', delta: 'SYNCHRONIZED', deltaType: 'neutral', subtext: 'Root Validated', icon: 'token' },
        { label: 'Audit Standard', value: 'AICTE / UGC', delta: 'AICTE TIER-1', deltaType: 'neutral', subtext: 'SIH-2024 Compliant', icon: 'shield' },
      ]}
    >
      {/* Control Ribbon */}
