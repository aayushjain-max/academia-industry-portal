...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', fullWidth = false, disabled, children, ...props }, ref) => {
    ...
    const variantStyles: Record<string, string> = {
      ...
      outline: 'bg-bg-surface text-fg-primary border border-border-strong hover:bg-bg-subtle shadow-[2px_2px_0px_0px_#18181B] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none font-semibold',
